...
const features = [
  ...
  },
  {
    ...
    description:
      "With GPS integration and IoT devices, our platform provides real-time tracking of shipments. Users can monitor the location and status of their goods at any time, ensuring they have up-to-date information to make informed decisions and respond promptly to any disruptions.",
  },
  {
...
const testimonials = [
  ...
  {
    quote:
      "We’ve reduced our transportation costs by 20% since switching to this platform. The resource optimization features are incredibly effective.",
    name: "Sarah L.",
  ...
  return (
    ...
    <NavbarComponent/>
      <div className="relative h-[600px] w-full">
        <img
          src="https://www.uberfreight.com/wp-content/uploads/2023/09/DRONE_CASTAIC_0001_R2-1.jpg.webp"
          alt="background"
